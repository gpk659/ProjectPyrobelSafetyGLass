...
CREATE TABLE IF NOT EXISTS `safetyglass`.`listechutte` (
  ...
  `dateMiseStock` DATETIME NULL DEFAULT NULL,
  ...
  `plateau_idPlateau` INT(10) NOT NULL,
  `listeoperateur_idOperateur` INT(11) NOT NULL,
  ...
  INDEX `fk_listechutte_listeoperateur1_idx` (`listeoperateur_idOperateur` ASC),
...
CREATE TABLE IF NOT EXISTS `safetyglass`.`listevolumesbons` (
  ...
  `commentaire` VARCHAR(255) NULL DEFAULT NULL,
  `plateau_idPlateau` INT(10) NOT NULL,
  `listechutte_idChutte` INT(10) NOT NULL,
  `listeoperateur_idOperateur` INT(11) NOT NULL,
  PRIMARY KEY (`idVolume`),
  UNIQUE INDEX `idVolume_UNIQUE` (`idVolume` ASC),
  INDEX `fk_listevolumesbons_plateau1_idx` (`plateau_idPlateau` ASC),
  INDEX `fk_listevolumesbons_listechutte1_idx` (`listechutte_idChutte` ASC),
